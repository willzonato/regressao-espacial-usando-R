...
author:
- Gabriel Zanela - gazela@gmail.com
- "Auditoria,\tAvaliaçãoes e Perícias de Engenharia"
- Instituto de Pós-Graduação - IPOG
date: "Florianópolis, SC, `r format(Sys.time(), '%d de %B de %Y')`"
output:
  pdf_document:
    fig_caption: yes
    fig_height: 3
...
Segundo Trivelloni[-@trivelloni07], 
...
Ainda de acordo com Trivelloni[-@trivelloni07], "vários trabalhos têm mostrado que esta combinação pode produzir melhores resultados que os conseguidos com cada método de forma isolada."
